...
public class Order {
    ...
    private String promotionIds; // 参与促销活动的id todo
    private Long postFee = 0L;// 邮费 todo  实际项目中应该根据具体地点生成具体邮费
    private Date createTime;// 创建时间
    private String shippingName;// 物流名称 todo
    private String shippingCode;// 物流单号 todo
    private Long userId;// 用户id
    private String buyerMessage;// 买家留言 todo
    ...
    @Transient
    private OrderStatus orderStatus;// 一对一的持久

    @Transient
    private List<OrderDetail> orderDetails;// 一对多的持久
}